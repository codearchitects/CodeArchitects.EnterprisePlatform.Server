...
{
  private readonly List<IJoinColumnModel> _columns;
  ...
  public IPrimaryKeyModel PrimaryKey => throw new NotSupportedException("Join entities do not have a primary key component.");
  ...
  public void AddColumn(IJoinColumnModel column)
  {
    _columns.Add(column);
  }
