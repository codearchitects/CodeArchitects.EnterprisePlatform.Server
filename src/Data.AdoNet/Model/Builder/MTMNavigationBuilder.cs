  ...
  where TTo : class
{
  ...
  public IMTMAssociationBuilder<TFrom, TTo> JunctionColumnNames(params string[] columnNames)
  {
    _columnNames.Clear();
  ...
  public IMTMAssociationBuilder<TFrom, TTo> JunctionTable(string tableName)
  {
