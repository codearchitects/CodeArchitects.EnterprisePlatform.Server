...
internal class HandlerDelegate<THandler, TMessage, TResult1, TResult2, TResult3> : BaseHandlerDelegateOneOf<THandler, TMessage, OneOf<TResult1, TResult2, TResult3>>
  where THandler : IMessageHandler<TMessage, OneOf<TResult1, TResult2, TResult3>>
{
  /// <summary>
  /// Creates a new <see cref="HandlerDelegate{THandler, TMessage, TResult1, TResult2, TResult3}"/> instance.
  /// </summary>
  ...
  protected override int OutputActionsArrayLength => 3;

  protected override Task ExecuteOutputActionsCoreAsync(IEnumerable<OutputAction> outputActions, TMessage message, OneOf<TResult1, TResult2, TResult3> result, CancellationToken cancellationToken)
  {
    return result.Match(
