...
internal class HandlerDelegate<THandler, TMessage, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6> : BaseHandlerDelegateOneOf<THandler, TMessage, OneOf<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6>>
  where THandler : IMessageHandler<TMessage, OneOf<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6>>
{
  /// <summary>
  /// Creates a new <see cref="HandlerDelegate{THandler, TMessage, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6}"/> instance.
  /// </summary>
  ...
  protected override int OutputActionsArrayLength => 6;

  protected override Task ExecuteOutputActionsCoreAsync(IEnumerable<OutputAction> outputActions, TMessage message, OneOf<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6> result, CancellationToken cancellationToken)
  {
    return result.Match(
