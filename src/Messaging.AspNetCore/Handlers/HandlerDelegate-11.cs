...
/// <typeparam name="TResult8">The eigth possibile type of the result.</typeparam>
/// <typeparam name="TResult9">The ninth possibile type of the result.</typeparam>
internal class HandlerDelegate<THandler, TMessage, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9> : BaseHandlerDelegateOneOf<THandler, TMessage, OneOf<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9>>
  where THandler : IMessageHandler<TMessage, OneOf<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9>>
{
  /// <summary>
  /// Creates a new <see cref="HandlerDelegate{THandler, TMessage, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9}"/> instance.
  /// </summary>
  ...
  protected override int OutputActionsArrayLength => 9;

  protected override Task ExecuteOutputActionsCoreAsync(IEnumerable<OutputAction> outputActions, TMessage message, OneOf<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9> result, CancellationToken cancellationToken)
  {
    return result.Match(
      ...
      f7: value => ExecuteOutputActionsAsync(outputActions, message, value, cancellationToken),
      f8: value => ExecuteOutputActionsAsync(outputActions, message, value, cancellationToken));
  }
}
