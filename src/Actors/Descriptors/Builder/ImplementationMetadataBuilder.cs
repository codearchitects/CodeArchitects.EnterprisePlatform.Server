  ...
  where TImplementation : TActor
{
  ...
  public IImplementationMetadataBuilder<TActor, TImplementation> HasConstructor(ConstructorInfo constructor)
  {
  ...
  public IImplementationMetadataBuilder<TActor, TImplementation> HasConstructor(params Type[] parameterTypes)
  {
  ...
  public IImplementationMetadataBuilder<TActor, TImplementation> HasConstructor(Expression<Func<IConstructorArgument<TActor>, TImplementation>> constructorExpression)
  {
