  ...
  where TActor : class
{
  ...
  public IActorMetadataBuilder<TActor> HasInterfaceType<TInterface>()
  ...
  public IActorMetadataBuilder<TActor> HasFactoryType(Type factoryType)
  {
  ...
  public IActorMetadataBuilder<TActor> HasFactoryType<TFactory>()
  ...
  public IActorMetadataBuilder<TActor> IsVirtual(bool isVirtual = true)
  {
  ...
  public IActorMetadataBuilder<TActor> HasState<TState>(Expression<Func<TActor, TState>> memberExpression)
  {
  ...
  public IActorMetadataBuilder<TActor> HasState<TState>(Expression<Func<TActor, TState>> memberExpression, Action<IStateComponentBuilder<TActor, TState>> configure)
  {
    if (memberExpression is null)
      throw new ArgumentNullException(nameof(memberExpression));
    if (memberExpression.Body is not MemberExpression body || body.Expression != memberExpression.Parameters[0])
  ...
  public IActorMetadataBuilder<TActor> HasConstructor(ConstructorInfo constructor)
  {
    if (constructor is null)
      throw new ArgumentNullException(nameof(constructor));

    _baseImplementationBuilder.HasConstructor(constructor);
    return this;
  }

  public IActorMetadataBuilder<TActor> HasConstructor(params Type[] parameterTypes)
  {
    if (parameterTypes is null)
      throw new ArgumentNullException(nameof(parameterTypes));

    _baseImplementationBuilder.HasConstructor(parameterTypes);
    return this;
  }

  public IActorMetadataBuilder<TActor> HasConstructor(Expression<Func<IConstructorArgument<TActor>, TActor>> constructorExpression)
  {
    if (constructorExpression is null)
      throw new ArgumentNullException(nameof(constructorExpression));

    _baseImplementationBuilder.HasConstructor(constructorExpression);
    return this;
  }

  public IActorMetadataBuilder<TActor> HasImplementation<TImplementation>()
  ...
  public IActorMetadataBuilder<TActor> HasImplementation<TImplementation>(Action<IImplementationMetadataBuilder<TActor, TImplementation>> configure)
    where TImplementation : TActor
  {
