...
{
  IGraphRequest<TResult> CreateRequest<TResult>(TUtf8Document utf8Document)
    where TResult : class;

  IGraphRequest<TResult, TVariables> CreateRequest<TResult, TVariables>(TUtf8Document utf8Document)
    where TResult : class
