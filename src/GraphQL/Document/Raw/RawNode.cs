...
internal partial class RawNode
{
  ...
  public RawNode(string document)
  {
  ...
  bool IEnumerator.MoveNext()
  {
    ...
    switch (CurrentIterator)
    {
      ...
      case IteratorKind.VariableDefinition:
        return VariableDefinitionMoveNext();
  ...
  {
    RawGraphDocument.Expect(in _lexer, expected);
  }

  private InvalidGraphQLDocumentException Unexpected()
  {
    return RawGraphDocument.Unexpected(in _lexer);
  }
