...
internal class ReferenceIncluder<TParent, TEntity> : IExpressionIncluder<TEntity>
  where TParent : class
  where TEntity : class
{
  private readonly ReferenceInclude<TParent, TEntity> _includeFunc;

  public ReferenceIncluder(IQueryable<TParent> queryable, ReferenceInclude<TParent, TEntity> includeFunc)
  {
    Queryable = queryable;
