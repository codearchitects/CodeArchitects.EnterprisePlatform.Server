...
{
  public ComponentIdSourceActorHost(ActorHost host, IActorManager<ComponentIdSourceActor, ComponentIdSourceActorState> manager, IImplementationFactory<ComponentIdSourceActor, ComponentIdSourceActorState> factory)
...
internal class ComponentIdSourceActorProxyFactory : ProxyFactory<IComponentIdSourceActorHost, IComponentIdSourceActor, ComponentIdSourceActorState>, IComponentIdSourceActorFactory
{
  ...
  {
    return CreateCoreAsync(state, new ComponentIdSourceActorState { _state = state }, cancellationToken);
  }
