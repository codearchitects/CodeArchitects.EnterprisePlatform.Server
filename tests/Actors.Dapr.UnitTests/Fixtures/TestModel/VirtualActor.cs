...
{
  public VirtualActorHost(ActorHost host, IActorManager<VirtualActor, VirtualActorState> manager, IImplementationFactory<VirtualActor, VirtualActorState> factory)
