...
public class CartItem
{
  ...
  public Cart? Cart { get; set; } // OTM intra-aggregate, on dependent
  public List<Product>? Products { get; set; } // MTM inter-aggregate
  public ShippingAddress? ShippingAddress { get; set; } // OTM inter-aggregate, on dependent
