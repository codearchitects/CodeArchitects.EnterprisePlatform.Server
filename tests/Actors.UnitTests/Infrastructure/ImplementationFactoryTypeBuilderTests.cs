...
public class ImplementationFactoryTypeBuilderTests
{
  ...
  public void Build_ShouldBuildCorrectType_WhenActorIsPolymorphic() // https://sharplab.io/#v2:
  {
    ...
    createMethodIL.VerifyIL(_ => _
      ...
      .Stloc_0()
      .Ldloc_0()
      .Ldstr(typeof(PolymorphicActorImplementation1).FullName!)
      .Call(typeof(string), "op_Equality", new[] { typeof(string), typeof(string) })
      .Brtrue_S(0x0023)
      .Ldloc_0()
      .Ldstr(typeof(PolymorphicActorImplementation2).FullName!)
      .Call(typeof(string), "op_Equality", new[] { typeof(string), typeof(string) })
      .Brtrue_S(0x0040)
      .Br(0x0068) // On SharpLab reference we have Br_S but potentially we could have many switch cases which forces to use Br
      .Ldarg_2()
      ...
      .Ldloc_0()
      .Ldstr("'.")
      .Call(typeof(string), nameof(string.Concat), new[] { typeof(string), typeof(string), typeof(string) })
